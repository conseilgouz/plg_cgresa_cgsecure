...
class plgcgresacgsecureInstallerScript
{
	...
	private $dir           = null;
	private $lang;
	private $installerName = 'plgcgresacgsecureinstaller';
	...
	private function postinstall_cleanup() {
		...
		{
			$f = JPATH_SITE . '/plugins/plg_cgresa_'.$this->extname.'/' . $folder;
		...
		$langFiles = [
			sprintf("%s/language/en-GB/en-GB.plg_cgresa_%s.ini", JPATH_ADMINISTRATOR, $this->extname),
			sprintf("%s/language/en-GB/en-GB.plg_cgresa_%s.sys.ini", JPATH_ADMINISTRATOR, $this->extname),
			sprintf("%s/language/fr-FR/fr-FR.plg_cgresa_%s.ini", JPATH_ADMINISTRATOR, $this->extname),
			sprintf("%s/language/fr-FR/fr-FR.plg_cgresa_%s.sys.ini", JPATH_ADMINISTRATOR, $this->extname),
		];
        ...
        try {
            ...
            Log::add('unable to enable plugin cgresa cgsecure', Log::ERROR, 'jerror');
        }
